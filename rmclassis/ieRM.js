var RMIE = {
    ...
    setCompetencesFromExcel: function () {
        ...
        do {
            ...
            // Pega o input que tenha o número de matrícula do indivíduo da linha da vez no Excel.

            // Seta o valor da nota dele no input


            ++i;
        } while (book.ActiveSheet.Cells(i+11, 2).Value == ""); // Enquanto a coluna de matrícula não estiver vazia no Excel, continue digitando nota
